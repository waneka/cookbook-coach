...
export default async function SavedMealPlansPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-3xl font-bold tracking-tight">Saved Meal Plans</h1>
          </div>
      ...
      {mealPlans.length === 0 ? (
        <Card>
          <CardHeader>
            <CardTitle>No saved meal plans yet</CardTitle>
            <CardDescription>
              Save a meal plan to reuse it later
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild>
